	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="作品名称" prop="zuopinmingcheng" >
				...
				<el-form-item v-else-if="ruleForm.zuopinwenjian" label="作品文件" prop="zuopinwenjian" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.zuopinwenjian)">
				...
				<el-form-item class="input" v-if="type!='info'"  label="作品简介" prop="zuopinjianjie" >
					<el-input v-model="ruleForm.zuopinjianjie" placeholder="作品简介" clearable  :readonly="ro.zuopinjianjie"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="作品简介" prop="zuopinjianjie" >
					<el-input v-model="ruleForm.zuopinjianjie" placeholder="作品简介" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="作品详情" prop="zuopinxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.zuopinxiangqing" 
					class="editor"
					myQuillEditor="zuopinxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zuopinxiangqing" label="作品详情" prop="zuopinxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.zuopinxiangqing"></span>
			</el-form-item>
		...
		data() {
			return {
				...
				rules: {
					...
					zuopinxiangqing: [
						{ required: true, message: '作品详情不能为空', trigger: 'blur' },
					],
					xuehao: [
					],
					xingming: [
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.zuopinxiangqing = this.ruleForm.zuopinxiangqing.replace(reg,'../../../springboot7u1602vl/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
