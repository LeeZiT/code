	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="竞赛类别" prop="jingsaileibie" >
					<el-select :disabled="ro.jingsaileibie" v-model="ruleForm.jingsaileibie" placeholder="请选择竞赛类别" >
						<el-option
				...
				<el-form-item v-else class="input" label="竞赛类别" prop="jingsaileibie" >
					<el-input v-model="ruleForm.jingsaileibie"
						placeholder="竞赛类别" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="年级" prop="nianji" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="奖励信息" prop="jianglixinxi" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="奖励信息"
					v-model="ruleForm.jianglixinxi" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.jianglixinxi" label="奖励信息" prop="jianglixinxi" >
				<span class="text">{{ruleForm.jianglixinxi}}</span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='jianglixinxi'){
							this.ruleForm.jianglixinxi = obj[o];
							this.ro.jianglixinxi = true;
							continue;
						}
						if(o=='gonghao'){
