		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="分数" prop="fenshu" >
					<el-input v-model.number="ruleForm.fenshu" placeholder="分数" clearable  :readonly="ro.fenshu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="分数" prop="fenshu" >
					<el-input v-model="ruleForm.fenshu" placeholder="分数" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="成绩" prop="chengji" >
					<el-select :disabled="ro.chengji" v-model="ruleForm.chengji" placeholder="请选择成绩" >
						<el-option
				...
				<el-form-item v-else class="input" label="成绩" prop="chengji" >
